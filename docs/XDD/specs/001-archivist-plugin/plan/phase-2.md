...
- [x] **T2.1 Type models, runtime guards, Settings migration registry** `[activity: domain-modeling]`
...
- [x] **T2.2 Hasher (WebCrypto SHA-256)** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T2.3 Utilities — paths, time, glob, retry** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T2.4 Logger with path-redaction gate** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T2.5 User-visible strings module** `[activity: frontend-ui]` `[parallel: true]`
